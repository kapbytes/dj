...
def langingpage(request):
    ...
    dict_list1 = list(my_values1.values('Name', '_Population',
                      'country_flag_url', 'country_name', 'Total_with_rent_1p'))
    for i in dict_list1:
        # print(i['_Population'])
...
def cost(request, name):
    ...
    return render(request, 'country.html', {'list': my_dict, 'max_vals': max_vals, 'city_dict_list': city_dict_list, 'state_list': state_list, 'com_url':com_urls,'com_url2':com_url2
                                            })
...
def city_cost(request, country_name, city_name):
    ...
    my_values1 = CityTable.objects.filter(Name=city_name.title())
    ...
    if my_values2:
        ...
        return render(request, 'state.html', {'list': my_dict, 'max_vals': max_vals, 'city_dict_list': city_dict_list})
    else:
        print('city')
        ...
        return render(request, 'city.html', {'list': my_dict, 'max_vals': max_vals, 'city_dict_list': city_dict_list})
